...
import { CreateSubscripcionComponent } from './pages/create-subscripcion/create-subscripcion.component';
export const routes: Routes = [
  ...
  { path: 'crear-subscripcion', component: CreateSubscripcionComponent },
];
